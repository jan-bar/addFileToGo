/**
本文件依赖LzmaUtil.c,是吧lzma1900\C\Util\Lzma\LzmaUtil.c里面改出来的
这个是Windows和Linux下都可以编译成功,在include目录下把lzma1900\C这里面的对应.h拷贝的
执行mingw32-make.exe -f makefile.util就可以编译出libLzmaUtil.a
**/
package LzmaSpec
